...
<body background="./joyofphp/bg.jpg">
<h1>Sam's Used Cars</h1>
<h3>Add Image</h3>
<?php include './joyofphp/db.php';
$vin = $_GET['VIN'];
...
<form action="./joyofphp/upload_file.php" method="post" enctype="multipart/form-data">
...
while ($result_ar = mysqli_fetch_assoc($result)) {
    ...
    echo "<img src='./joyofphp/uploads/$image' width= '250'>  " ;
}
}
$mysqli->close();
include 'footer.php';
