...
if ($mysqli->query("CREATE DATABASE Mannythings_Cars") === TRUE) {
    echo "<p>Database Mannythings_Cars created</P>";
}
else
{
    echo "Error creating Mannythings_Cars database: " . mysql_error()."<br>";
}
//select a database to work with
$mysqli->select_db("Mannythings_Cars");
   Echo ("Selected the Mannythings_Cars database");
